...
from attack_related.VBAD.attack.video_attackforcolab import untargeted_video_attack
...
data_path = '/content/drive/MyDrive/pr1vid/wsvids'
model_path = '/content/drive/MyDrive/pr1model/bi-model_type-baseline_gru_auc_0.150000_ep-10.pth'
image_model_path = '/content/drive/MyDrive/pr1model/all_c40.p' #all_c40 works well, full_raw works fine, the rest are terrible
model_type = 'xception'
...
if args.atk == 'white':
    if args.model == 'rnn':
        ...
        with open('configforcolab.yaml', 'r') as f:
            config = yaml.load(f)
